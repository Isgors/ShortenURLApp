 ...
 *
 * Signals are NOT injected externally.
 * They are generated at build time by the Gradle plugin.
 */
class OrthosRuntime internal constructor(
    ...
    suspend fun evaluate(): OrthosVerdict {
        ...
        // Load signals generated by plugin
        val allSignals = OrthosSignals.generated()
